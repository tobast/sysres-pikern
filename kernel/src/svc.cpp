...
SVC(int execute_file(int, execution_context*), 23)
SVC(int is_folder(int), 24)
SVC(int num_children(int), 25)
SVC(int get_child(int, int), 26)
SVC(void get_node_name(int, char*, int), 27)
SVC(int new_socket(), 28)
